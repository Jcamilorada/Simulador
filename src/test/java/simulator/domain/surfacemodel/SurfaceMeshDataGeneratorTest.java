...
public class SurfaceMeshDataGeneratorTest
{
    private Color color;

    private final SurfaceMeshDataGenerator testInstance = new SurfaceMeshDataGenerator();
    ...
    private void verifyPointsTable(PointsTable table)
    {
        ...
        Point expectedPoint1 = new Point(0D, 0D, SurfaceModelCalculator.caculatePNR(0, 0), 1, color);
        Point expectedPoint2 = new Point(0D, 1D, SurfaceModelCalculator.caculatePNR(0, 1), 2, color);
        Point expectedPoint3 = new Point(1D, 0D, SurfaceModelCalculator.caculatePNR(1, 0), 3, color);
        Point expectedPoint4 = new Point(1D, 1D, SurfaceModelCalculator.caculatePNR(1, 1), 4, color);
