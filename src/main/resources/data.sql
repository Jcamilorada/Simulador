...
insert into parameters (id, name, value) values (2, 'volumenes para dilusion', 100);
insert into parameters (id, name, value) values (2, 'volumenes para dilusion', 200);
insert into parameters (id, name, value) values (2, 'volumenes para dilusion', 250);
insert into parameters (id, name, value) values (2, 'volumenes para dilusion', 500);
